...
describe('sitters reducer', () => {
  ...
  //     {customerId: 'jak123', _id: '1', username: 'azat', password: 'secret', name: 'Azat Baran', female: false, birthDate: new Date(1995, 2, 16),
  ...
  //CUSTOMERID = jak1234 in webservice it is jak123
